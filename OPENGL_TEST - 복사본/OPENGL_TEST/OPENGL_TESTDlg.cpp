...
void COPENGL_TESTDlg::Setting_Draw()
{
	...
	shaderProgram2 = create_program2();
...
*/
	...
	float vertices2[] = {
		...
		0.5f, 0.28125f, 0.0f, 1.0f, 1.0f, 0.0f, 1.0f, 1.0f, // top right
		0.5f, -0.28125f, 0.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f, // bottom right
		-0.5f, -0.28125f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f, // bottom left
		-0.5f, 0.28125f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f  // top left 
	};
	...
	for (int i = 0; i < 5; i++)
	{
		...
		char path[100] = { 0, };
		sprintf(path, "image\\슬라이드%d.png", i + 1);
		unsigned char *data = stbi_load(path, &width, &height, &nrChannels, 0);
		// unsigned char *data1 = stbi_load("image\\container.jpg", &width, &height, &nrChannels, 0);
		if (data)
		{
	...
	{		
		...
		if (flag == 0)
		{
			...
			for (int i = 0; i < 5; i++)
			{
				...
				//object_color_R = 1;		 object_color_G += 0.025;	 object_color_B = 0;
				//glUniform4f(vertexColorLocation, object_color_R, object_color_G, object_color_B, 1.0f);
				...
				// printf("radian : %f, x좌표 :%f, y좌표 : %f\n", radian, 0.5f*cos(radian), 0.5f*sin(radian));
				glm::mat4 trans = glm::mat4(1.0f);
				trans = glm::translate(trans, glm::vec3(0.85f*cos(radian*PI / 180), 0.85f*sin(radian*PI / 180), 0.0f));
...
GLuint COPENGL_TESTDlg::create_program2() {
